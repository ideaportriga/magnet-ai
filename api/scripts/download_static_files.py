#!/usr/bin/env python3
"""Download static files for Swagger UI, ReDoc and Stoplight Elements offline mode."""
...
FILES_TO_DOWNLOAD = {
    ...
    # Swagger UI
    f"https://cdn.jsdelivr.net/npm/swagger-ui-dist@{SWAGGER_VERSION}/swagger-ui-bundle.js": "swagger-ui-bundle.js",
    f"https://cdn.jsdelivr.net/npm/swagger-ui-dist@{SWAGGER_VERSION}/swagger-ui.css": "swagger-ui.css",
    f"https://cdn.jsdelivr.net/npm/swagger-ui-dist@{SWAGGER_VERSION}/swagger-ui-standalone-preset.js": "swagger-ui-standalone-preset.js",
}
