...
class WebChannel(BaseModel):
    ...
    show_close_button: bool = Field(
        default=False, description="Web channel show close button"
    )
...
class MsTeamsChannel(MsTeamsChannelBase):
    ...
    secret_value_encrypted: Optional[str] = Field(
        default=None,
        alias="secret_value",
        description="MS Teams secret value encrypted",
    )
...
class MsTeamsChannelUpdate(MsTeamsChannelBase):
    ...
    secret_value_encrypted: Optional[str] = Field(
        default=None,
        exclude=True,
        description="MS Teams secret value encrypted (used when secret_value is empty, not saved)",
    )
    ...
    def validate_required_fields(self):
        if self.enabled:
            ...
            if missing_fields:
                ...
                raise ValueError(f"MS Teams channel requires {joined} when enabled")
...
class SlackChannel(SlackChannelBase):
    ...
    token_encrypted: Optional[str] = Field(
        default=None, alias="token", description="Slack token encrypted"
    )
    signing_secret_encrypted: Optional[str] = Field(
        default=None,
        alias="signing_secret",
        description="Slack signing secret encrypted",
    )
    client_secret_encrypted: Optional[str] = Field(
        default=None, alias="client_secret", description="Slack client secret encrypted"
    )
...
class SlackChannelUpdate(SlackChannelBase):
    ...
    # encrypted are only used for validation, not saved to database
    token_encrypted: Optional[str] = Field(
        default=None, exclude=True, description="Slack token encrypted"
    )
    signing_secret_encrypted: Optional[str] = Field(
        default=None, exclude=True, description="Slack signing secret encrypted"
    )
    client_secret_encrypted: Optional[str] = Field(
        default=None, exclude=True, description="Slack client secret encrypted"
    )
...
class WhatsAppChannel(WhatsAppChannelBase):
    ...
    token_encrypted: Optional[str] = Field(
        default=None, alias="token", description="WhatsApp access token encrypted"
    )
    app_secret_encrypted: Optional[str] = Field(
        default=None, alias="app_secret", description="WhatsApp app secret encrypted"
    )
...
class WhatsAppChannelUpdate(WhatsAppChannelBase):
    ...
    # encrypted are only used for validation, not saved to database
    token_encrypted: Optional[str] = Field(
        default=None, exclude=True, description="WhatsApp access token encrypted"
    )
    app_secret_encrypted: Optional[str] = Field(
        default=None, exclude=True, description="WhatsApp app secret encrypted"
    )
    ...
    def validate_required_fields(self):
        if self.enabled:
            ...
            if missing_fields:
                joined = ", ".join(missing_fields)
                raise ValueError(f"WhatsApp channel requires {joined} when enabled")
...
class AgentChannels(BaseModel):
    ...
    web: Optional[WebChannel] = Field(
        default=None, description="Web channel configuration"
    )
    ms_teams: Optional[MsTeamsChannel] = Field(
        default=None, description="MS Teams channel configuration"
    )
    slack: Optional[SlackChannel] = Field(
        default=None, description="Slack channel configuration"
    )
    whatsapp: Optional[WhatsAppChannel] = Field(
        default=None, description="WhatsApp channel configuration"
    )
...
class AgentChannelsUpdate(BaseModel):
    ...
    web: Optional[WebChannelUpdate] = Field(
        default=None, description="Web channel configuration"
    )
    ms_teams: Optional[MsTeamsChannelUpdate] = Field(
        default=None, description="MS Teams channel configuration"
    )
    slack: Optional[SlackChannelUpdate] = Field(
        default=None, description="Slack channel configuration"
    )
    whatsapp: Optional[WhatsAppChannelUpdate] = Field(
        default=None, description="WhatsApp channel configuration"
    )
