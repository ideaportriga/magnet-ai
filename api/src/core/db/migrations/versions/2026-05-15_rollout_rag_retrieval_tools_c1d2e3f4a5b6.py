...
Create Date: 2026-05-15 16:00:00.000000+00:00
"""
...
TABLES = ("rag_tools", "retrieval_tools")
...
def _apply_to(table: str) -> None:
    # tenant_id → backfill → NOT NULL → FK
    ...
    # Drop legacy global UNIQUE on system_name.
    op.execute(
        f"""
        DO $$
        DECLARE cname text;
