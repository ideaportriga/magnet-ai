...
def schema_upgrades() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["knowledge_graphs.id"],
            name=op.f(
                "fk_knowledge_graph_metadata_discoveries_graph_id_knowledge_graphs"
            ),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ...
            name=op.f(
                "fk_knowledge_graph_metadata_discoveries_source_id_knowledge_graph_sources"
            ),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "id", name=op.f("pk_knowledge_graph_metadata_discoveries")
        ),
        sa.UniqueConstraint(
            "graph_id",
            "source_id",
    ...
    op.create_index(
        op.f("ix_knowledge_graph_metadata_discoveries_graph_id"),
        "knowledge_graph_metadata_discoveries",
        ["graph_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_knowledge_graph_metadata_discoveries_name"),
        "knowledge_graph_metadata_discoveries",
        ["name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_knowledge_graph_metadata_discoveries_source_id"),
        "knowledge_graph_metadata_discoveries",
        ["source_id"],
        unique=False,
    )
...
def schema_downgrades() -> None:
    ...
    op.drop_index(
        op.f("ix_knowledge_graph_metadata_discoveries_source_id"),
        table_name="knowledge_graph_metadata_discoveries",
    )
    op.drop_index(
        op.f("ix_knowledge_graph_metadata_discoveries_name"),
        table_name="knowledge_graph_metadata_discoveries",
