...
Revision ID: e73a517576e8
Revises: c3b1a6e8d0f2
Create Date: 2026-01-08 14:28:29.165665+00:00
...
def schema_upgrades() -> None:
    ...
    op.create_table('knowledge_graph_metadata_discoveries',
    sa.Column('id', GUID, nullable=False),
    sa.Column('graph_id', GUID, nullable=False, comment='Foreign key to knowledge_graphs'),
    sa.Column('source_id', GUID, nullable=False, comment='Foreign key to knowledge_graph_sources'),
    ...
    sa.Column('origin', sa.String(length=50), nullable=True, comment='Origin where this field was observed (file, source, llm)'),
    ...
    sa.ForeignKeyConstraint(['graph_id'], ['knowledge_graphs.id'], name=op.f('fk_knowledge_graph_metadata_discoveries_graph_id_knowledge_graphs'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['source_id'], ['knowledge_graph_sources.id'], name=op.f('fk_knowledge_graph_metadata_discoveries_source_id_knowledge_graph_sources'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_knowledge_graph_metadata_discoveries')),
    sa.UniqueConstraint('graph_id', 'source_id', 'origin', 'name', name='uq_knowledge_graph_metadata_discoveries_name')
    )
    op.create_index(op.f('ix_knowledge_graph_metadata_discoveries_graph_id'), 'knowledge_graph_metadata_discoveries', ['graph_id'], unique=False)
    op.create_index(op.f('ix_knowledge_graph_metadata_discoveries_name'), 'knowledge_graph_metadata_discoveries', ['name'], unique=False)
    op.create_index(op.f('ix_knowledge_graph_metadata_discoveries_source_id'), 'knowledge_graph_metadata_discoveries', ['source_id'], unique=False)
...
def schema_downgrades() -> None:
    ...
    op.alter_column('teams_meeting', 'meeting_id',
               ...
               existing_nullable=True)
    op.drop_index(op.f('ix_knowledge_graph_metadata_discoveries_source_id'), table_name='knowledge_graph_metadata_discoveries')
    op.drop_index(op.f('ix_knowledge_graph_metadata_discoveries_name'), table_name='knowledge_graph_metadata_discoveries')
    op.drop_index(op.f('ix_knowledge_graph_metadata_discoveries_graph_id'), table_name='knowledge_graph_metadata_discoveries')
    op.drop_table('knowledge_graph_metadata_discoveries')
    # ### end Alembic commands ###
