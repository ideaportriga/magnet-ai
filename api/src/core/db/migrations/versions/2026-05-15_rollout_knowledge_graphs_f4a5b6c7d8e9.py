...
FK — every controller path enters through the root and RLS on the root
prevents cross-tenant lookup of `graph_id`. Record-level enforcement on the
root is applied in the controller layer.

Revision ID: f4a5b6c7d8e9
Revises: e3f4a5b6c7d8
Create Date: 2026-05-15 18:30:00.000000+00:00
"""
