...
class SettingsController(Controller):
    ...
    @get("/seed/preview", guards=[require_permission(Permission.SETTINGS_READ)])
    ...
    @post("/seed/populate-one", guards=[require_permission(Permission.SETTINGS_WRITE)])
    ...
    @post("/seed/populate", guards=[require_permission(Permission.SETTINGS_WRITE)])
    ...
    @post("/seed/check-exists", guards=[require_permission(Permission.SETTINGS_READ)])
    ...
    @post("/seed/upload-json", guards=[require_permission(Permission.SETTINGS_WRITE)])
    ...
    @get("/seed/export-preview", guards=[require_permission(Permission.SETTINGS_READ)])
    ...
    @post("/seed/export-json", guards=[require_permission(Permission.SETTINGS_READ)])
