...
- ✅ How to create separate plugin repositories
...
- **[EXTERNAL_PLUGINS_STRATEGY.md](../../../EXTERNAL_PLUGINS_STRATEGY.md)** - Complete strategy guide
- **[PLUGIN_SYSTEM.md](../../../PLUGIN_SYSTEM.md)** - Plugin system overview
- **[EXTERNAL_PLUGIN_PACKAGING.md](../../../EXTERNAL_PLUGIN_PACKAGING.md)** - How to package plugins
