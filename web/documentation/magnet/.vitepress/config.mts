...
export default withMermaid(
  defineConfig({
    ...
    head: [['link', { rel: 'icon', href: `${base}logo.svg`, type: 'image/svg+xml' }]],
    themeConfig: {
      logo: '/logo.svg',
        ...
        themeConfig: {
          ...
          sidebar: {
              ...
              },
              {
                ...
                items: [
                  ...
                  },
                  {
                    text: 'Variants',
                    collapsed: true,
                    items: [{ text: 'Using variants', link: '/docs/en/quickstarts/variants/using-variants' }],
                  },
                  {
                    text: 'AI Apps',
                    collapsed: true,
            ...
            '/docs/en/devops/': [
              {
                text: 'Introduction',
                items: [
                  { text: 'Overview', link: '/docs/en/devops/overview' },
                  { text: 'Get Started', link: '/docs/en/devops/get-started' },
                ],
              },
              {
                text: 'Deployment',
                ...
                items: [
                  { text: 'Docker Compose', link: '/docs/en/devops/deployment/docker-compose/' },
                  { text: 'Kubernetes/OpenShift', link: '/docs/en/devops/deployment/kubernetes/' },
                  {
                    text: 'Cloud Platforms',
                    collapsed: true,
                    items: [{ text: 'Azure', link: '/docs/en/devops/deployment/cloud/azure' }],
                  },
                ],
              },
              {
                ...
                items: [
                  { text: 'Database Initialization', link: '/docs/en/devops/database-ops/database-initialization' },
                  { text: 'Schema Changes', link: '/docs/en/devops/database-ops/schema-changes' },
            ...
            '/docs/en/developers/': [
              {
                text: 'General',
                items: [{ text: 'Overview', link: '/docs/en/developers/overview' }],
              },
              {
                ...
                items: [
                  ...
                  { text: 'Run with Docker Compose', link: '/docs/en/developers/setup/run-with-docker-compose' },
