...
4. Review the Topic Selection Prompt Template *(optional)*. Default Prompt Template should work well as a starting point, but it can be replaced if necessary. Use Agent Preview to understand areas for improvement.

5. Review the Topic Processing Prompt Template *(optional)*.

6. Enable Post-processing to collect metrics like case resolution or user sentiment *(optional)*.

7. Adjust UI settings like user feedback or welcome message *(optional)*.
