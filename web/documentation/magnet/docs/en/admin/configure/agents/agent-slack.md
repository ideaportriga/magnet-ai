...
4. If you use OAuth, click **Connect to Slack** and complete the OAuth consent dialog to store the installation.
...
```json
{
    ...
    "oauth_config": {
        "redirect_urls": [
            "https://{AI_BRIDGE_BASE}/api/user/agents/slack/oauth_redirect"
        ],
        "scopes": {
            "bot": [
                "chat:write",
