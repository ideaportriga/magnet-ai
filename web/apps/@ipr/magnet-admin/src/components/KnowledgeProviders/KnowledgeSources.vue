<template lang="pug">
  ...
  //- knowledge-providers-new-knowledge-source(:showNewDialog='showNewDialog', @cancel='showNewDialog = false')
  </template>
  <script setup>
  import { ref, computed } from 'vue'
  import { debounce } from 'lodash'
  import controls from '@/config/knowledge_providers/knowledge_sources'
