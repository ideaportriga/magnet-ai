    ...
    <km-card class="card-style" style="min-inline-size: 800px">
      ...
      <div class="km-card-section card-section-style mb-md">
        ...
        <div v-if="stepper === 0" class="stack full-width" data-gap="0">
          ...
          <km-input ref="nameRef" v-model="name" class="mb-md" height="30px" :rules="[required()]" />
          ...
          <km-input ref="system_nameRef" v-model="system_name" class="mb-md" height="30px" :rules="[required(), validSystemName()]">
...
export default {
  ...
  methods: {
    ...
    proceed() {
      const validStates = [validateRef(this.$refs.nameRef), validateRef(this.$refs.system_nameRef)]
