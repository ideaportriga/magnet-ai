    ...
    <div class="flex-none">
      <div class="cluster" data-gap="lg" data-justify="between">
        <div class="km-input-label text-text-grey">
          {{ m.common_model() }}
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="modelLabel" border-radius="8px" height="36px" type="text" readonly @input="modelLabel = $event" />
        </div>
      </div>
      ...
      <div class="cluster" data-gap="lg" data-justify="between">
        <div class="km-input-label text-text-grey">
          ...
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="totalTokens" border-radius="8px" height="36px" type="text" readonly @input="totalTokens = $event" />
        </div>
        <div class="km-input-label text-text-grey">
          {{ m.agents_totalCost() }}
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="totalCost" border-radius="8px" height="36px" type="text" readonly @input="totalCost = $event" />
        </div>
      </div>
      <km-separator class="my-md" />
      <div class="cluster mb-sm" data-gap="lg" data-justify="between">
        <div class="km-input-label text-text-grey">
          ...
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="inputTokens" border-radius="8px" height="36px" type="text" readonly @input="inputTokens = $event" />
        </div>
        <div class="km-input-label text-text-grey">
          {{ m.agents_inputCost() }}
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="inputCost" border-radius="8px" height="36px" type="text" readonly @input="inputCost = $event" />
      ...
      <div class="cluster mb-sm" data-gap="lg" data-justify="between">
        <div class="km-input-label text-text-grey">
          ...
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="outputTokens" border-radius="8px" height="36px" type="text" readonly @input="outputTokens = $event" />
        </div>
        <div class="km-input-label text-text-grey">
          {{ m.agents_outputCost() }}
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="outputCost" border-radius="8px" height="36px" type="text" readonly @input="outputCost = $event" />
      ...
      <div class="cluster mb-sm" data-gap="lg" data-justify="between">
        <div class="km-input-label text-text-grey">
          ...
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="cachedTokens" border-radius="8px" height="36px" type="text" readonly @input="cachedTokens = $event" />
        </div>
        <div class="km-input-label text-text-grey">
          {{ m.agents_cachedCost() }}
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="cachedCost" border-radius="8px" height="36px" type="text" readonly @input="cachedCost = $event" />
      ...
      <div class="cluster" data-gap="lg" data-justify="between">
        <div class="km-input-label text-text-grey">
          {{ m.agents_latency() }}
          <km-input ref="input" :placeholder="m.common_typeYourText()" :model-value="latency" border-radius="8px" height="36px" type="text" readonly @input="latency = $event" />
        </div>
      </div>
    </div>
  </div>
